...
const Sidebar = () => {
  ...
  const menuItems = [
    { path: '/dashboard', label: 'Home', icon: <Home />, activeIcon: <HomeActive /> },
    { path: '/dashboard/products', label: 'Product', icon: <Product />, activeIcon: <ProductActive /> },
    { path: '/dashboard/categories', label: 'Category', icon: <Category />, activeIcon: <CategoryActive /> },
    { path: '/dashboard/orders', label: 'Orders', icon: <Orders />, activeIcon: <OrdersActive /> },
    { path: '/dashboard/promotions', label: 'Promotion', icon: <Promotion />, activeIcon: <PromotionActive /> },
    { path: '/dashboard/banners', label: 'Banner Management', icon: <Banner />, activeIcon: <BannerActive /> },
    { path: '/dashboard/ratings', label: 'Rating', icon: <Rating />, activeIcon: <RatingActive /> },
    { path: '/dashboard/stocks', label: 'Stock', icon: <Stock />, activeIcon: <StockActive /> },
  ];
